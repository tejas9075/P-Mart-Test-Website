...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Patil Mart</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/P-MART .svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Patil Mart</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">The Site is Work in Progress....!!</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">As a computer science student, I have a strong foundation in programming, software development, and computer science theory. I am experienced in Java, Python, and HTML and have developed several web applications.
My experience includes web-based, multi-threaded applications and front-end development with the latest web technologies. 
I am always looking to learn new technologies and am currently exploring Oracle Database, data science and machine learning. Currently seeking full-time Software Engineer opportunities.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">About to be an Experienced Fresher with a go-getter attitude. I am a quick learner and have good communication skills which helps me to get along well with people.
Constantly thriving and seeking learning opportunities with a hardworking and diligent approach. Always willing to take up challenges that I can improve my knowledge in various areas of Computer science.</p>
				</div>
			</div>
			<!-- About Section Button-->
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-light"
					href="https://www.linkedin.com/in/tejas-patil-aa899a16b/"> <i
					class="fas fa-download me-2"></i> LINKEDIN
				</a>
			</div>
		</div>
	</section>
						...
						<div class="d-none" id="submitSuccessMessage">
							<div class="text-center mb-3">
								...
								To activate this form, sign up at <br /> <a
									href="https://t.me/PShoppingMart">P Shopping Mart</a>
							</div>
						</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						16, Nandgaon Khandeshwar <br /> Tejas, Mo 9075157631
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About Patil Mart</h4>
					<p class="lead mb-0">
						Get the best deals with all online markets at your fingertips...
					</p>
				</div>
			</div>
		</div>
